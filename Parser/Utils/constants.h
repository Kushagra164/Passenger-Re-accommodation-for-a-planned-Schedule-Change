...
enum ACTION_CD{NIL4,HK,PD};
enum CLASS_CD{NIL5,FC,BC,PC,EC};

enum SPECIAL_NAME1 {NIL1,INS,INF,CHD,ADT,UNN,S65};
enum SPECIAL_NAME2 {NIL2,NRPS,NRSA};
enum SSR_CD {NIL3,WCHR,WCHS,WCHC,LANG,MAAS,UNMR,BLND,DEAF,EXST,MEAL,NSST};
