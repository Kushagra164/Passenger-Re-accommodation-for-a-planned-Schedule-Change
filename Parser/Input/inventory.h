...
void getInventoryInput(ifstream &inventoryFile)
{
    ...
    while (getline(inventoryFile, line))
    {
        ...
        if (scheduleMap[scheduleID]->status == SCHEDULE_STATUS::SCHEDULE_CANCELLED)
            CancelledFlights.insert(uuid);
        ...
        totalCapacity = atoi(tempString.c_str());
        getline(inputString, tempString, ',');
        totalInventory = atoi(tempString.c_str());
        getline(inputString, tempString, ',');
        ...
        getline(inputString, tempString, ',');
        fcTotalCapacity = atoi(tempString.c_str());
        getline(inputString, tempString, ',');
        bcTotalCapacity = atoi(tempString.c_str());
        getline(inputString, tempString, ',');
        pcTotalCapacity = atoi(tempString.c_str());
        getline(inputString, tempString, ',');
        ecTotalCapacity = atoi(tempString.c_str());

        getline(inputString, tempString, ',');
        fcTotalInventory = atoi(tempString.c_str());
        getline(inputString, tempString, ',');
        getline(inputString, tempString, ',');
        getline(inputString, tempString, ',');

        getline(inputString, tempString, ',');
        bcTotalInventory = atoi(tempString.c_str());
        getline(inputString, tempString, ',');
        getline(inputString, tempString, ',');
        getline(inputString, tempString, ',');

        getline(inputString, tempString, ',');
        pcTotalInventory = atoi(tempString.c_str());
        getline(inputString, tempString, ',');
        getline(inputString, tempString, ',');
        getline(inputString, tempString, ',');

        getline(inputString, tempString, ',');
        ecTotalInventory = atoi(tempString.c_str());
        getline(inputString, tempString, ',');
        getline(inputString, tempString, ',');
        getline(inputString, tempString, ',');
        ...
        else
        {
            ...
            if (newInventory->status == INVENTORY_STATUS::INVENTORY_CANCELLED)
                CancelledFlights.insert(uuid);

            if (newInventory->status == INVENTORY_STATUS::INVENTORY_DELAYED)
                DelayedFlights[uuid] = delayTime;
        }
