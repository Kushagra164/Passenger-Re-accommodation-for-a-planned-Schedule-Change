...
public:
    ...
    Schedule(int _scheduleID,string _carrierCD, pair<string,string> _equipmentNo,Time _departureTime, 
        ...
        string _flightPattern, int _flightNum, string _status):
        ...
        endDate(_endDate), flightPattern(_flightPattern), flightNum(_flightNum), status(getScheduleStatus(_status))
        {
